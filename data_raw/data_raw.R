...
# SFO Landing
cmd_stats <- "curl 'https://data.sfgov.org/resource/fpux-q53t.json?$limit=50000' | jq -r '.[] |[.activity_period, .operating_airline, .operating_airline_iata_code,
.published_airline, .published_airline_iata_code, .geo_summary, .geo_region,
